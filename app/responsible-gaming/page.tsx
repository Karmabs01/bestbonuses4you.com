  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          At Bestbonuses4you, we believe that gambling should always be a form of
        ...
        <p>
          ...
          <a target="_blank" href="mailto:support@bestbonuses4you.com.">
            support@bestbonuses4you.com.
          </a>
        </p>
        ...
        <p>
          Bestbonuses4you only accepts players who are at least 18 years old and
