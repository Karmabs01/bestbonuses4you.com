...
export const metadata: Metadata = {
  title: "Privacy Policy | Bestbonuses4you",
  description:
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        <h1 className="mb-3">Welcome to bestbonuses4you.com</h1>
        <p>
        ...
        <p>
          bestbonuses4you.com is not intended for individuals under the age of 18.
        ...
        <p>
          ...
          <a href="mailto:admin@bestbonuses4you.com"> admin@bestbonuses4you.com</a>. We will make
          reasonable efforts to address your inquiries in a timely manner. By
          using bestbonuses4you.com, you agree to the practices outlined in this
