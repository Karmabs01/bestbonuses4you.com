...
export const metadata: Metadata = {
  title: "Terms and Conditions | Bestbonuses4you",
  description:
    "Welcome to bestbonuses4you.com. These Terms & Conditions govern your access to and use of the Website. By accessing and using the Website, you agree to comply with these Terms & Conditions. If you do not agree with these terms, please refrain from using the Website.",
};
  ...
  return (
    <div className="page-gaming pt-10 pb-10">
      <div className="main__container">
        ...
        <p>
          Welcome to bestbonuses4you.com. These Terms & Conditions govern your
        ...
        <p>
          bestbonuses4you.com holds no responsibility for the accuracy, validity,
        ...
        <p>
          By providing your email address on bestbonuses4you.com, you consent to
        ...
        <p>
          ...
          every promotional email sent by bestbonuses4you.com. It may take up to
        ...
        <p>
          ...
          bestbonuses4you.com. Users are prohibited from reproducing,
          distributing, modifying, or creating derivative works without explicit
          permission.
        </p>
        <h2 className="mb-3">Limitation of Liability</h2>
        <p>
          bestbonuses4you.com shall not be liable for any direct, indirect,
        ...
        <p>
          bestbonuses4you.com reserves the right to modify, suspend, or terminate
        ...
        <p>
          By accessing and using bestbonuses4you.com, you agree to abide by these
          ...
          us at{" "}
          <a href="mailto:info@bestbonuses4you.com">info@bestbonuses4you.com</a>.
        </p>
        ...
        <p>
          ...
          <a target="_blank" href="https://bestbonuses4you.com/">
            bestbonuses4you.com
          </a>{" "}
        </p>
      </div>
